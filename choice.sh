...
foodOptions=("pizza" "burgers" "chinese" "sushi" "thai" "italian" "shit")
  ...
  getChoice -q "What do you feel like eating?" -o foodOptions -i 6 -m 4 -v "firstChoice"
  printf "\n First choice is '${firstChoice}'\n"

  getChoice -q "Select another option in case the first isn't available" -o foodOptions
  printf "\n Second choice is '${selectedChoice}'\n"